...
Page({
  ...
  onVisitTimeInput(e) { this.setData({ newVisitTime: e.detail.value }); },
  onDiagnosisInput(e) { this.setData({ newDiagnosis: e.detail.value }); },
  onTreatmentInput(e) { this.setData({ newTreatment: e.detail.value }); },
  onMedicationInput(e) { this.setData({ newMedication: e.detail.value }); },
  onDoctorInput(e) { this.setData({ newDoctor: e.detail.value }); },
